...
@Repository
public class ClientOrderRepositoryAdapter implements ClientOrderRepositoryPort {
  private final ClientOrderJpaRepository clientOrderRepository;
  ...
  public ClientOrderRepositoryAdapter(
      ClientOrderJpaRepository clientOrderRepository, EntityManager entityManager) {
